...
export default function InputBox({type, name, label, required, value}: InputBoxProps) {
    return (
        <div className="relative py-2">
            ...
            focus:outline-none focus:ring-0 focus:border-orange-500 peer text-sm" placeholder=" " />
            <label className="absolute text-gray-500 text-sm duration-300 transform -translate-y-4 scale-75 bg-white 
