...
export default function CallHistory() {
  return (
      <div className="h-screen w-full p-4 pt-0 md:p-4 bg-orange-50/40 dark:bg-black flex flex-col">
        <div className="top-0 h-fit sticky bg-[#FFFCF8] dark:bg-black z-50">
